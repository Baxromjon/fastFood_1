...
const structure = [
  ...
  { id: 3, label: 'Orders', link: '/app/orders', icon: <TableIcon /> },
  ...
  { id: 13, label: 'My recent', link: '', icon: <Dot size="small" color="secondary" /> },
  { id: 14, label: 'Starred', link: '', icon: <Dot size="small" color="primary" /> },
  { id: 15, label: 'Background', link: '', icon: <Dot size="small" color="secondary" /> },
];
