        ...
        <div className={classes.root} >
            <div className={classes.overlay} />
                 <motion.div ref={ref} className={classes.titleContainer} variants={variantsCard}  initial="hidden" animate={controls}>
                    ...
                    <Typography gutterBottom variant='h1' component='h1'>Tayyor tansiq taomlar sizni kutmoqda </Typography>
                    <div>
                        <Button component={Link} to={ABOUT_PATH} variant='contained' color='secondary'>ko`proq</Button>
                    </div>
             </motion.div>
        </div>
    )
